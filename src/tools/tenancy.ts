...
const contactAssignmentCreate = {
  object_type: z
    .string()
    .describe(
      "Assigned object type, e.g. 'dcim.device', 'dcim.site', 'circuits.circuit' (required).",
    ),
  object_id: z
    .number()
    .int()
    .describe("Numeric id of the object the contact is assigned to (required)."),
...
export function registerTenancy(server: McpServer): void {
  ...
  crud(
    ...
    "tenant_group",
    "tenant_groups",
    "tenant groups (nestable)",
    { ...nameSlug, parent_id: z.number().int().optional() },
    nestedGroupCreate,
    nestedGroupUpdate,
  ...
  crud(
    ...
    "tenant",
    "tenants",
    "tenants (customers/departments)",
    { ...nameSlug, group_id: z.number().int().optional() },
    tenantCreate,
    tenantUpdate,
  ...
  crud(
    ...
    "contact_assignment",
    "contact_assignments",
    "assignments of contacts to objects",
    { contact_id: z.number().int().optional(), role_id: z.number().int().optional() },
    contactAssignmentCreate,
    contactAssignmentUpdate,
    ["contact", "role", "priority", "object_type"],
  );
}
